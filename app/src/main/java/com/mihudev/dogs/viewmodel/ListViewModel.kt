...
import com.mihudev.dogs.model.DogDao
import com.mihudev.dogs.model.DogDatabase
import com.mihudev.dogs.model.DogsApiService
import com.mihudev.dogs.util.NotificationsHelper
import com.mihudev.dogs.util.SharedPreferencesHelper
...
class ListViewModel(application: Application) : BaseViewModel(application) {
    ...
    private fun checkCacheDuration() {
        ...
        try {
            ...
            refreshTime = cachePreferenceInt.times(1000 * 1000 * 10000L)
